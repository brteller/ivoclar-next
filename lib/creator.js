export const CREATOR = {
  ...
  description: 'Tetric® by Ivoclar — premium dental composite resins and restorative materials for durable, esthetic restorations. Trusted by dental professionals worldwide.',
...
export function getSEOMetadataFromParams(params, data, origin) {
  ...
  const category = data?.category?.name || humanizeSlug(params?.category) || CREATOR.name;
  const parts = [];
